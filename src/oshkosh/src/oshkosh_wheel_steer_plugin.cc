...
#include <oshkosh/oshkosh_wheels_steerConfig.h>
// Boost Bind
...
public:
  void Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
  {
    ...
    this->model_reconfiguration_server = new dynamic_reconfigure::Server<oshkosh::oshkosh_wheels_steerConfig>(*(this->Ros_nh));
...
public:
  void dynamic_Reconfiguration_callback(oshkosh::oshkosh_wheels_steerConfig &config, uint32_t level)
  {
...
public:
  ...
  dynamic_reconfigure::Server<oshkosh::oshkosh_wheels_steerConfig> *model_reconfiguration_server;
